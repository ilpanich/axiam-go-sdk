...
const (
	UserService_GetUser_FullMethodName             = "/axiam.v1.UserService/GetUser"
	UserService_ValidateCredentials_FullMethodName = "/axiam.v1.UserService/ValidateCredentials"
)
...
//
// User service for lookups and credential validation.
type UserServiceClient interface {
	// Retrieve a user by ID.
	GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
	// Validate username/email + password without issuing tokens.
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "axiam.v1.UserService",
